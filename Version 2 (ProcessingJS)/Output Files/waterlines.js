...
function waterlinesData()
{
	...
	pointer_polygons_waterlines = new Polygon(polygon0, "stroke", "1");
	...
	pointer_polygons_waterlines = new Polygon(polygon1, "stroke", "2");
	...
	pointer_polygons_waterlines = new Polygon(polygon2, "stroke", "3");
	...
	pointer_polygons_waterlines = new Polygon(polygon3, "stroke", "4");
	...
	pointer_polygons_waterlines = new Polygon(polygon4, "stroke", "5");
	...
	pointer_polygons_waterlines = new Polygon(polygon5, "stroke", "6");
	...
	pointer_polygons_waterlines = new Polygon(polygon6, "stroke", "7");
	...
	pointer_polygons_waterlines = new Polygon(polygon7, "stroke", "8");
	...
	pointer_polygons_waterlines = new Polygon(polygon8, "stroke", "9");
