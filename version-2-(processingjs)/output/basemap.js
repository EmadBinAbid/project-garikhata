...
function basemapData()
{
	...
	pointer_polygons_basemap = new Polygon(polygon0, "stroke", "GARIKHATA_BASE_0");
	...
	pointer_polygons_basemap = new Polygon(polygon1, "stroke", "GARIKHATA_BASE_1");
	...
	pointer_polygons_basemap = new Polygon(polygon2, "stroke", "GARIKHATA_BASE_2");
	...
	pointer_polygons_basemap = new Polygon(polygon3, "stroke", "GARIKHATA_BASE_3");
	...
	pointer_polygons_basemap = new Polygon(polygon4, "stroke", "GARIKHATA_BASE_4");
	...
	pointer_polygons_basemap = new Polygon(polygon5, "stroke", "GARIKHATA_BASE_5");
	...
	pointer_polygons_basemap = new Polygon(polygon6, "stroke", "GARIKHATA_BASE_6");
	...
	pointer_polygons_basemap = new Polygon(polygon7, "stroke", "GARIKHATA_BASE_7");
	...
	pointer_polygons_basemap = new Polygon(polygon8, "stroke", "GARIKHATA_BASE_8");
	...
	pointer_polygons_basemap = new Polygon(polygon9, "stroke", "GARIKHATA_BASE_9");
	...
	pointer_polygons_basemap = new Polygon(polygon10, "stroke", "GARIKHATA_BASE_10");
	...
	pointer_polygons_basemap = new Polygon(polygon11, "stroke", "GARIKHATA_BASE_11");
	...
	pointer_polygons_basemap = new Polygon(polygon12, "stroke", "GARIKHATA_BASE_12");
	...
	pointer_polygons_basemap = new Polygon(polygon13, "stroke", "GARIKHATA_BASE_13");
	...
	pointer_polygons_basemap = new Polygon(polygon14, "stroke", "GARIKHATA_BASE_14");
	...
	pointer_polygons_basemap = new Polygon(polygon15, "stroke", "GARIKHATA_BASE_15");
	...
	pointer_polygons_basemap = new Polygon(polygon16, "stroke", "GARIKHATA_BASE_16");
	...
	pointer_polygons_basemap = new Polygon(polygon17, "stroke", "GARIKHATA_BASE_17");
		...
		if(collidePointPoly(mouseX, mouseY, array_polygons_basemap[i].array_of_vectors) == true)
		{
			...
			for(var j=0; j<plotInfoArray.length; j++)
			{
				if(array_polygons_basemap[i].plotId == plotInfoArray[j].plotId)
				{
					...
					tip = new Tooltip("Plot ID: " + array_polygons_basemap[i].plotId, mouseX, mouseY, 250, 35);
					tip.show();
				}
				else
				{
